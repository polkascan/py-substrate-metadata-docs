...
| None | `VenueId` | ```u64```
| None | `InstructionId` | ```u64```
| None | `SettlementType<BlockNumber>` | ```{'SettleOnAffirmation': None, 'SettleOnBlock': 'u32'}```
...
```python
{
    'created_at': (None, 'u64'),
    'instruction_id': 'u64',
    'settlement_type': {'SettleOnAffirmation': None, 'SettleOnBlock': 'u32'},
