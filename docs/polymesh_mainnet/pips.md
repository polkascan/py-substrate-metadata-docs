...
```python
{
    ...
    'proposal': {
        ...
        'Babe': {
            ...
            'report_equivocation': {
                'equivocation_proof': {
                    'first_header': 'scale_info::337',
                    'offender': '[u8; 32]',
                    'second_header': 'scale_info::337',
                    'slot': 'u64',
                },
                'key_owner_proof': {
                    'session': 'u32',
        ...
        'UpgradeCommitteeMembership': 'Call',
        'Utility': {
            'batch': {'calls': ['scale_info::376']},
            'batch_all': {'calls': ['scale_info::376']},
            'batch_atomic': {'calls': ['scale_info::376']},
            'batch_old': {'calls': ['scale_info::376']},
            'batch_optimistic': {'calls': ['scale_info::376']},
            'dispatch_as': {
                'as_origin': {
            ...
            'force_batch': {'calls': ['scale_info::376']},
            'relay_tx': {
                'call': {'call': 'scale_info::376', 'nonce': 'u64'},
                'signature': {
                    'Ecdsa': '[u8; 65]',
                    'Ed25519': '[u8; 64]',
                    'Sr25519': '[u8; 64]',
