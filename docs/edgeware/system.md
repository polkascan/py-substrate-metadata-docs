...
```python
{
    ...
    'per_class': {
        ...
        'normal': {
            'base_extrinsic': 125000000,
            'max_extrinsic': 1299875000000,
            'max_total': 1500000000000,
            'reserved': 0,
        },
        'operational': {
            'base_extrinsic': 125000000,
            'max_extrinsic': 1799875000000,
