...
[
    {
        'event': {
            ...
            'DaoCoreModule': {
                'AppDeRegistered': ('u8', 'AccountId'),
                'AppRegistered': ('u8', 'AccountId'),
                'OrgJoined': ('u32', 'AccountId'),
                'OrgRegistered': ('u32', 'AccountId'),
            },
            'Democracy': {
            ...
            'DoraRewards': {
                'DistributeReward': ('AccountId', 'AccountId', 'u128'),
                'EndleasingBlock': 'u32',
                'UpdateContributorsInfo': ('AccountId', 'u128', 'u128'),
            },
            'Multisig': {
                'MultisigApproval': {
                    'approving': 'AccountId',
            ...
            'OrmlXcm': {
                'Sent': {'message': ['scale_info::63'], 'to': 'scale_info::50'},
            },
            'ParachainSystem': {
            ...
            'PolkadotXcm': {
                ...
                'VersionChangeNotified': ('scale_info::50', 'u32'),
            },
            'Preimage': {
                'Cleared': {'hash': '[u8; 32]'},
                'Noted': {'hash': '[u8; 32]'},
            ...
            'QuadraticFunding': {
                ...
                'ProjectRegistered': ('[u8; 32]', 'AccountId'),
                'RoundEnded': 'u32',
                'RoundStarted': 'u32',
                'VoteCost': ('[u8; 32]', 'u128'),
                'VoteSucceed': ('[u8; 32]', 'AccountId', 'u128'),
            },
            'Scheduler': {
                'CallLookupFailed': {
                    'error': 'scale_info::34',
