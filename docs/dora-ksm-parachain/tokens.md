...
| -------- | -------- | -------- |
| currency_id | `T::CurrencyId` | ```('KSM', 'DORA')```
...
result = substrate.query(
    'Tokens', 'Accounts', ['AccountId', ('KSM', 'DORA')]
)
```
...
```python
result = substrate.query(
    'Tokens', 'Locks', ['AccountId', ('KSM', 'DORA')]
)
```
...
```python
result = substrate.query(
    'Tokens', 'Reserves', ['AccountId', ('KSM', 'DORA')]
)
```
