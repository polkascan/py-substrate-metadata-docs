...
```python
{
    'interior': {
        ...
        'X2': (
            {
                'AccountId32': {'id': '[u8; 32]', 'network': 'scale_info::78'},
                'AccountIndex64': {
                    'index': 'u64',
                    'network': 'scale_info::78',
                },
