...
[
    {
        'event': {
            ...
            'AssetRegistry': {
                'AssetRegistered': {
                    'asset_id': 'scale_info::197',
                    'metadata': 'scale_info::196',
                },
                'AssetUpdated': {
                    'asset_id': 'scale_info::197',
                    'metadata': 'scale_info::196',
            ...
            'HonzonBridge': {
                'BridgedStableCoinCurrencyIdSet': {
                    'bridged_stable_coin_currency_id': 'scale_info::53',
                },
