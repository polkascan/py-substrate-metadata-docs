...
[
    {
        'event': {
            ...
            'PolkadotXcm': {
                ...
                'NotifyTargetMigrationFail': ('scale_info::164', 'u64'),
                'NotifyTargetSendFail': (
                    'scale_info::128',
                    'u64',
                    'scale_info::125',
                ),
                'ResponseReady': ('u64', 'scale_info::149'),
                'ResponseTaken': 'u64',
                'Sent': (
                    'scale_info::128',
                    'scale_info::128',
