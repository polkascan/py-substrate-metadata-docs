...
| Name | Value |
| -------- | -------- |
| Spec name     | totem-parachain     |
| Implementation name     | totem-parachain     |
| Spec version     | 4     |
| SS58 Format     | 2007     |
| Token symbol      | KPX     |
| Token decimals      | 12     |
...
| -------- | -------- | -------- | -------- | -------- | -------- |
| [Accounting](accounting.md) | [0](accounting.md#calls) | [1](accounting.md#events) | [4](accounting.md#storage-functions) | [0](accounting.md#constants) | [4](accounting.md#errors)
...
| [Sudo](sudo.md) | [4](sudo.md#calls) | [3](sudo.md#events) | [0](sudo.md#storage-functions) | [0](sudo.md#constants) | [1](sudo.md#errors)
