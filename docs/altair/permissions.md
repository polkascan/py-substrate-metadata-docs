...
| role | `T::Role` | ```{'PoolRole': {'PoolAdmin': None, 'Borrower': None, 'PricingAdmin': None, 'LiquidityAdmin': None, 'MemberListAdmin': None, 'LoanAdmin': None, 'TrancheInvestor': ('[u8; 16]', 'u64')}, 'PermissionedCurrencyRole': {'Holder': 'u64', 'Manager': None, 'Issuer': None}}```
...
#### Python
```python
constant = substrate.get_constant('Permissions', 'MaxTranches')
```
---------
## Errors
