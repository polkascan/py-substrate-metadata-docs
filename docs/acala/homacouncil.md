...
```python
call = substrate.compose_call(
    'HomaCouncil', 'disapprove_proposal', {'proposal_hash': 'scale_info::12'}
)
```
...
```python
result = substrate.query(
    'HomaCouncil', 'ProposalOf', ['scale_info::12']
)
```
...
```python
result = substrate.query(
    'HomaCouncil', 'Voting', ['scale_info::12']
)
```
...
#### Python
```python
constant = substrate.get_constant('HomaCouncil', 'MaxProposalWeight')
```
---------
## Errors
