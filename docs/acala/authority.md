...
```python
call = substrate.compose_call(
    'Authority', 'remove_authorized_call', {'hash': 'scale_info::12'}
)
```
...
```python
result = substrate.query(
    'Authority', 'SavedCalls', ['scale_info::12']
)
```
