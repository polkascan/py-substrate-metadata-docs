...
result = substrate.query(
    'SygmaFeeHandlerRouter', 'HandlerType', [
    (
        'u8',
        {
            'Abstract': '[u8; 32]',
...
#### Return value
```python
('BasicFeeHandler', 'PercentageFeeHandler', 'DynamicFeeHandler')
```
---------
## Errors
