...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 8]', 'scale_info::52'),
                'InvalidFormat': '[u8; 8]',
            ...
            'KylinFeed': {
                ...
                'NFTAccepted': {
                    'collection_id': 'u32',
                    'nft_id': 'u32',
                    'recipient': 'scale_info::119',
                    'sender': 'AccountId',
                },
                'NFTBurned': {'nft_id': 'u32', 'owner': 'AccountId'},
                'NFTRejected': {
                    'collection_id': 'u32',
                    'nft_id': 'u32',
                    'sender': 'AccountId',
                ...
                'ResourceAccepted': {'nft_id': 'u32', 'resource_id': 'u32'},
                'ResourceAdded': {'nft_id': 'u32', 'resource_id': 'u32'},
                'ResourceRemoval': {'nft_id': 'u32', 'resource_id': 'u32'},
            ...
            'KylinOraclePallet': {
                ...
                'FeedDataError': ('scale_info::95', 'u32'),
                'FeedDataSent': 'u32',
                'NewApiFeed': {
                    'feed': 'scale_info::99',
                    'key': 'Bytes',
                ...
                'NewParaEvt': {'para_id': 'u32'},
                'NewParaEvt1': {'sender': 'AccountId'},
                'NewParaFeedData': {
                    'para_id': 'u32',
                    'values': [('Bytes', 'i64')],
                },
            ...
            'OrmlXcm': {
                'Sent': {'message': ['scale_info::66'], 'to': 'scale_info::53'},
            },
            'ParachainSystem': {
            ...
            'PolkadotXcm': {
                ...
                'VersionChangeNotified': ('scale_info::53', 'u32'),
            },
            'Preimage': {
                'Cleared': {'hash': '[u8; 32]'},
                'Noted': {'hash': '[u8; 32]'},
