...
| amount | `T::Balance` | ```u128```
| destination_status | `BalanceStatus` | ```('Free', 'Reserved')```
...
#### Python
```python
constant = substrate.get_constant('Kton', 'ExistentialDeposit')
```
---------
### MaxLocks
...
#### Python
```python
constant = substrate.get_constant('Kton', 'MaxLocks')
```
---------
### MaxReserves
...
#### Python
```python
constant = substrate.get_constant('Kton', 'MaxReserves')
```
---------
## Errors
