...
[
    {
        'event': {
            ...
            'BridgeCrabParachainDispatch': {
                ...
                'MessageDispatched': ('[u8; 4]', ('[u8; 4]', 'u64'), 'scale_info::54'),
            ...
            'BridgeCrabParachainMessages': {
                ...
                'MessagesDelivered': ('[u8; 4]', 'scale_info::107'),
                'ParameterUpdated': {
            ...
            'BridgeDarwiniaMessages': {
                'MessageAccepted': ('[u8; 4]', 'u64'),
                'MessagesDelivered': ('[u8; 4]', 'scale_info::107'),
                'ParameterUpdated': {'DarwiniaToCrabConversionRate': 'u128'},
            },
            'Council': {
            ...
            'CrabParachainFeeMarket': {
                ...
                'OrderReward': ('[u8; 4]', 'u64', 'scale_info::116'),
            ...
            'Democracy': {
                ...
                'Executed': {'ref_index': 'u32', 'result': 'scale_info::54'},
                'ExternalTabled': None,
            ...
            'ImOnline': {
                ...
                'SomeOffline': {'offline': [('AccountId', 'scale_info::47')]},
            },
            'Indices': {
            ...
            'Proxy': {
                ...
                'ProxyExecuted': {'result': 'scale_info::54'},
            },
            'Recovery': {
                'AccountRecovered': {
            ...
            'Utility': {
                ...
                'DispatchedAs': {'result': 'scale_info::54'},
                'ItemCompleted': None,
            },
            'Vesting': {
