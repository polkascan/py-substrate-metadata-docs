...
```python
call = substrate.compose_call(
    'CouncilCollective', 'disapprove_proposal', {'proposal_hash': 'scale_info::12'}
)
```
...
```python
result = substrate.query(
    'CouncilCollective', 'ProposalOf', ['scale_info::12']
)
```
...
```python
result = substrate.query(
    'CouncilCollective', 'Voting', ['scale_info::12']
)
```
...
#### Python
```python
constant = substrate.get_constant('CouncilCollective', 'MaxProposalWeight')
```
---------
## Errors
