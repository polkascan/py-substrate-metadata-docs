...
```python
call = substrate.compose_call(
    'TreasuryCouncilCollective', 'close_old_weight', {
    'index': 'u32',
    'length_bound': 'u32',
    'proposal_hash': '[u8; 32]',
...
```python
call = substrate.compose_call(
    'TreasuryCouncilCollective', 'disapprove_proposal', {'proposal_hash': '[u8; 32]'}
)
```
...
```python
result = substrate.query(
    'TreasuryCouncilCollective', 'ProposalOf', ['[u8; 32]']
)
```
...
```python
result = substrate.query(
    'TreasuryCouncilCollective', 'Voting', ['[u8; 32]']
)
```
