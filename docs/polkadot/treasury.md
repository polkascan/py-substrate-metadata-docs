...
| -------- | -------- | -------- |
| index | `SpendIndex` | ```u32```
| payment_id | `<T::Paymaster as Pay>::Id` | ```u64```
...
```python
{
    ...
    'asset_kind': {
        ...
        'V3': {
            'asset_id': {
                'Abstract': '[u8; 32]',
                'Concrete': {'interior': 'scale_info::67', 'parents': 'u8'},
            },
            'location': {
                'interior': {
                    'Here': None,
    ...
    'beneficiary': {
        ...
        'V2': {
            'interior': {
                ...
                'X2': ('scale_info::79', 'scale_info::79'),
                'X3': ('scale_info::79', 'scale_info::79', 'scale_info::79'),
                'X4': (
                    'scale_info::79',
                    'scale_info::79',
                    'scale_info::79',
    ...
    'expire_at': 'u32',
    'status': {'Attempted': {'id': 'u64'}, 'Failed': None, 'Pending': None},
    'valid_from': 'u32',
}
```
---------
