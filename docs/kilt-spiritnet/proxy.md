...
| proxy_type | `T::ProxyType` | ```('Any', 'NonTransfer', 'Governance', 'ParachainStaking', 'CancelProxy', 'NonDepositClaiming')```
| delay | `BlockNumberFor<T>` | ```u64```
...
#### Return value
```python
([{'call_hash': 'scale_info::12', 'height': 'u64', 'real': 'AccountId'}], 'u128')
```
---------
### Proxies
