...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 8]', 'scale_info::39'),
                'InvalidFormat': '[u8; 8]',
            ...
            'PolkadotXcm': {
                ...
                'InvalidResponderVersion': ('scale_info::40', 'u64'),
                'Notified': ('u64', 'u8', 'u8'),
                ...
                'SupportedVersionChanged': ('scale_info::40', 'u32'),
                'UnexpectedResponse': ('scale_info::40', 'u64'),
                'VersionChangeNotified': ('scale_info::40', 'u32'),
            },
            'Proxy': {
                'Announced': {
                    'call_hash': '[u8; 32]',
                ...
                'ProxyExecuted': {'result': 'scale_info::81'},
                'ProxyRemoved': {
                    'delay': 'u32',
                    'delegatee': 'AccountId',
                    'delegator': 'AccountId',
            ...
            'Utility': {
                ...
                'DispatchedAs': {'result': 'scale_info::81'},
                'ItemCompleted': None,
