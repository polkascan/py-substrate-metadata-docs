...
| proxy_type | `T::ProxyType` | ```('AutoCompound',)```
...
#### Return value
```python
([{'delay': 'u32', 'delegate': 'AccountId', 'proxy_type': ('AutoCompound', )}], 'u128')
```
---------
## Constants
