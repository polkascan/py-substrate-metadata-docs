...
```python
call = substrate.compose_call(
    'Triumvirate', 'disapprove_proposal', {'proposal_hash': 'scale_info::10'}
)
```
...
| -------- | -------- | -------- |
| proposal_hash | `T::Hash` | ```scale_info::10```
...
```python
result = substrate.query(
    'Triumvirate', 'ProposalOf', ['scale_info::10']
)
```
...
```python
result = substrate.query(
    'Triumvirate', 'Voting', ['scale_info::10']
)
```
