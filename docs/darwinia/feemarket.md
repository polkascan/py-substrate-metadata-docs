...
```python
call = substrate.compose_call(
    'FeeMarket', 'set_assigned_relayers_number', {'number': 'u32'}
)
```
...
```python
call = substrate.compose_call(
    'FeeMarket', 'set_slash_protect', {'slash_protect': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'FeeMarket', 'update_locked_collateral', {'new_collateral': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'FeeMarket', 'update_relay_fee', {'new_fee': 'u128'}
)
```
...
```python
result = substrate.query(
    'FeeMarket', 'AssignedRelayersNumber', []
)
```
...
```python
result = substrate.query(
    'FeeMarket', 'CollateralSlashProtect', []
)
```
...
```python
result = substrate.query(
    'FeeMarket', 'RelayersMap', ['AccountId']
)
```
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'AssignedRelayerSlashRatio')
```
---------
### CollateralPerOrder
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'CollateralPerOrder')
```
---------
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'ConfirmRelayersRewardRatio')
```
---------
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'DutyRelayersRewardRatio')
```
---------
### LockId
#### Value
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'LockId')
```
---------
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'MessageRelayersRewardRatio')
```
---------
### MinimumRelayFee
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'MinimumRelayFee')
```
---------
### Slot
 The slot times set
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'Slot')
```
---------
### TreasuryPalletId
...
#### Python
```python
constant = substrate.get_constant('FeeMarket', 'TreasuryPalletId')
```
---------
## Errors
