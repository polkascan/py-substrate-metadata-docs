...
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'cancel_enrollment', {}
)
```
...
```python
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'enroll_and_lock_collateral', {
...
```python
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'set_assigned_relayers_number', {'number': 'u32'}
)
```
...
```python
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'set_slash_protect', {'slash_protect': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'update_locked_collateral', {'new_collateral': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'DarwiniaParachainFeeMarket', 'update_relay_fee', {'new_fee': 'u128'}
)
```
...
| None | `LaneId` | ```[u8; 4]```
| None | `MessageNonce` | ```u64```
| None | `RewardItem<T::AccountId, BalanceOf<T, I>>` | ```{'to_assigned_relayers': 'scale_info::125', 'to_treasury': (None, 'u128'), 'to_message_relayer': (None, ('AccountId', 'u128')), 'to_confirm_relayer': (None, ('AccountId', 'u128'))}```
...
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'AssignedRelayers', []
)
```
...
```python
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'AssignedRelayersNumber', []
)
```
...
```python
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'CollateralSlashProtect', []
)
```
...
```python
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'Orders', [('[u8; 4]', 'u64')]
)
```
...
```python
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'Relayers', []
)
```
...
```python
result = substrate.query(
    'DarwiniaParachainFeeMarket', 'RelayersMap', ['AccountId']
)
```
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'AssignedRelayerSlashRatio')
```
---------
### CollateralPerOrder
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'CollateralPerOrder')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'ConfirmRelayersRewardRatio')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'DutyRelayersRewardRatio')
```
---------
### LockId
#### Value
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'LockId')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'MessageRelayersRewardRatio')
```
---------
### MinimumRelayFee
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'MinimumRelayFee')
```
---------
### Slot
 The slot times set
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'Slot')
```
---------
### TreasuryPalletId
...
#### Python
```python
constant = substrate.get_constant('DarwiniaParachainFeeMarket', 'TreasuryPalletId')
```
---------
## Errors
