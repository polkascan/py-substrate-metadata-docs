...
result = substrate.query(
    'FarmingRewards', 'RewardCurrencies', [
    {
        'ForeignAsset': 'u32',
        'LendToken': 'u32',
        'LpToken': (
