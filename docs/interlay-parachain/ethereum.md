...
call = substrate.compose_call(
    ...
    'transaction': {
        'EIP1559': {
            ...
            'chain_id': 'u64',
            'gas_limit': 'scale_info::186',
            'input': 'Bytes',
            'max_fee_per_gas': 'scale_info::186',
            'max_priority_fee_per_gas': 'scale_info::186',
            'nonce': 'scale_info::186',
            'odd_y_parity': 'bool',
            'r': 'scale_info::12',
            's': 'scale_info::12',
            'value': 'scale_info::186',
        },
        'EIP2930': {
            'access_list': [
                {
...
result = substrate.query(
    'Ethereum', 'BlockHash', ['scale_info::186']
)
```
...
```python
{
    'header': {
        'beneficiary': '[u8; 20]',
        'difficulty': 'scale_info::186',
        'extra_data': 'Bytes',
        'gas_limit': 'scale_info::186',
        'gas_used': 'scale_info::186',
        'logs_bloom': '[u8; 256]',
        'mix_hash': 'scale_info::12',
        'nonce': '[u8; 8]',
        'number': 'scale_info::186',
