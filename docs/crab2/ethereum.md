...
result = substrate.query(
    'Ethereum', 'BlockHash', ['scale_info::249']
)
```
...
```python
{
    'header': {
        'beneficiary': '[u8; 20]',
        'difficulty': 'scale_info::249',
        'extra_data': 'Bytes',
        'gas_limit': 'scale_info::249',
        'gas_used': 'scale_info::249',
        'logs_bloom': '[u8; 256]',
        'mix_hash': 'scale_info::12',
        'nonce': '[u8; 8]',
        'number': 'scale_info::249',
