...
| -------- | -------- | -------- |
| candidate | `<T as frame_system::Config>::AccountId` | ```[u8; 20]```
...
| Name | Type | Composition
| -------- | -------- | -------- |
| member | `<T as frame_system::Config>::AccountId` | ```[u8; 20]```
...
| Name | Type | Composition
| -------- | -------- | -------- |
| new_members | `Vec<(<T as frame_system::Config>::AccountId, BalanceOf<T>)>` | ```[('[u8; 20]', 'u128')]```
...
| Name | Type | Composition
| -------- | -------- | -------- |
| seat_holder | `<T as frame_system::Config>::AccountId` | ```[u8; 20]```
| amount | `BalanceOf<T>` | ```u128```
...
#### Return value
```python
[{'deposit': 'u128', 'stake': 'u128', 'who': '[u8; 20]'}]
```
---------
### RunnersUp
...
```python
result = substrate.query(
    'PhragmenElection', 'Voting', ['[u8; 20]']
)
```

#### Return value
```python
{'deposit': 'u128', 'stake': 'u128', 'votes': ['[u8; 20]']}
```
---------
## Constants
