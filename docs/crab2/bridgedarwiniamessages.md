...
| Name | Type | Composition
| -------- | -------- | -------- |
| None | `Vec<ReceivedMessages<ReceivalResult>>` | ```[{'lane': '[u8; 4]', 'receive_results': [('u64', {'Dispatched': 'scale_info::160', 'InvalidNonce': None, 'TooManyUnrewardedRelayers': None, 'TooManyUnconfirmedMessages': None, 'PreDispatchValidateFailed': None})], 'skipped_for_not_enough_weight': ['u64']}]```
