...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 32]', 'scale_info::86'),
                'InvalidFormat': '[u8; 32]',
            ...
            'BridgeDarwiniaMessages': {
                ...
                'MessagesDelivered': {
                    'lane_id': '[u8; 4]',
                    'messages': 'scale_info::164',
                },
                'MessagesReceived': ['scale_info::158'],
            ...
            'DarwiniaFeeMarket': {
                ...
                'OrderReward': ('[u8; 4]', 'u64', 'scale_info::174'),
            ...
            'PolkadotXcm': {
                ...
                'Attempted': {
                    ...
                    'Error': 'scale_info::83',
                    'Incomplete': ('scale_info::9', 'scale_info::83'),
                },
                'FeesPaid': ('scale_info::87', ['scale_info::101']),
                'InvalidQuerier': (
                    'scale_info::87',
                    'u64',
                    'scale_info::87',
                ...
                'InvalidQuerierVersion': ('scale_info::87', 'u64'),
                'InvalidResponder': (
                    'scale_info::87',
                    'u64',
                    (None, 'scale_info::87'),
                ...
                'VersionNotifyStarted': ('scale_info::87', ['scale_info::101']),
