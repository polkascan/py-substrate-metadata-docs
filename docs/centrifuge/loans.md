    ...
    (
        {
            ...
            'info': {
                ...
                'interest_rate': 'u128',
                'restrictions': {
                    'borrows': 'scale_info::191',
                    'max_borrow_amount': 'scale_info::190',
                    'repayments': 'scale_info::192',
                },
                'schedule': {
                    'interest_payments': 'scale_info::185',
                    'maturity': 'scale_info::184',
                    'pay_down_schedule': 'scale_info::186',
                },
                'valuation_method': {
                    'DiscountedCashFlow': 'scale_info::188',
                    'OutstandingDebt': None,
                },
            },
            'loan_id': 'u64',
