...
```python
{
    'best_submission': (
        None,
        {
            'Healthy': {'score': 'u128', 'solution': ['scale_info::136']},
            'Unhealthy': {
                'reserve_improvement_score': (None, 'u128'),
                'risk_buffer_improvement_scores': (None, ['u128']),
                'solution': ['scale_info::136'],
                'state': ['scale_info::141'],
            },
        },
    ),
...
```python
{
    'changes': {
        ...
        'tranches': {
            'NewValue': [
                {'seniority': (None, 'u32'), 'tranche_type': 'scale_info::153'},
            ],
            'NoChange': None,
        },
    },
...
#### Python
```python
constant = substrate.get_constant('PoolSystem', 'ParachainId')
```
---------
### PoolDeposit
