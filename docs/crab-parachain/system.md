...
[
    {
        'event': {
            ...
            'BridgeCrabDispatch': {
                ...
                'MessageCallValidateFailed': ('[u8; 4]', ('[u8; 4]', 'u64'), 'scale_info::99'),
                ...
                'MessageDispatched': ('[u8; 4]', ('[u8; 4]', 'u64'), 'scale_info::35'),
            ...
            'BridgeCrabMessages': {
                ...
                'MessagesDelivered': ('[u8; 4]', 'scale_info::94'),
                'ParameterUpdated': {
            ...
            'CrabFeeMarket': {
                ...
                'OrderReward': ('[u8; 4]', 'u64', 'scale_info::105'),
            ...
            'FromCrabIssuing': {
                'RemoteBackingAccountUpdated': 'AccountId',
                'RemoteUnlockForFailure': ('u64', 'u64'),
            ...
            'RemoteGovernance': {
                'Emergency': None,
                'EmergencySafeguardDone': {'result': 'scale_info::35'},
                'Recovery': None,
                'RemoteCallEnacted': {'result': 'scale_info::35'},
            },
