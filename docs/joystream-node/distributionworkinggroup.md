...
call = substrate.compose_call(
    'DistributionWorkingGroup', 'add_opening', {
    'description': 'Bytes',
    'opening_type': (
        'Leader',
        'Regular',
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'apply_on_opening', {
    'p': {
        'description': 'Bytes',
        'member_id': 'u64',
        'opening_id': 'u64',
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'cancel_opening', {'opening_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'decrease_stake', {
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'fill_opening', {
    'opening_id': 'u64',
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'fund_working_group_budget', {
    'amount': 'u128',
    'member_id': 'u64',
    'rationale': 'Bytes',
}
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'increase_stake', {
    'stake_balance_delta': 'u128',
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'lead_remark', {'msg': 'Bytes'}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'leave_role', {'rationale': (None, 'Bytes'), 'worker_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'set_budget', {'new_budget': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'set_status_text', {'status_text': (None, 'Bytes')}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'slash_stake', {
    'penalty': 'u128',
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'spend_from_budget', {
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'terminate_role', {
    'penalty': (None, 'u128'),
    'rationale': (None, 'Bytes'),
    'worker_id': 'u64',
}
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'update_reward_account', {
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'update_reward_amount', {
    'reward_per_block': (None, 'u128'),
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'update_role_account', {
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'withdraw_application', {'application_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'DistributionWorkingGroup', 'worker_remark', {'msg': 'Bytes', 'worker_id': 'u64'}
)
```
...
result = substrate.query(
    'DistributionWorkingGroup', 'ActiveWorkerCount', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'ApplicationById', ['u64']
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'Budget', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'CurrentLead', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'NextApplicationId', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'NextOpeningId', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'NextWorkerId', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'OpeningById', ['u64']
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'StatusTextHash', []
)
```
...
```python
result = substrate.query(
    'DistributionWorkingGroup', 'WorkerById', ['u64']
)
```
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'LeaderOpeningStake')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'MaxWorkerNumberLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'MinUnstakingPeriodLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'MinimumApplicationStake')
```
---------
### RewardPeriod
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'RewardPeriod')
```
---------
...
#### Python
```python
constant = substrate.get_constant('DistributionWorkingGroup', 'StakingHandlerLockId')
```
---------
## Errors
