...
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'add_opening', {
    'description': 'Bytes',
    'opening_type': (
        'Leader',
        'Regular',
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'apply_on_opening', {
    'p': {
        'description': 'Bytes',
        'member_id': 'u64',
        'opening_id': 'u64',
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'cancel_opening', {'opening_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'decrease_stake', {
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'fill_opening', {
    'opening_id': 'u64',
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'fund_working_group_budget', {
    'amount': 'u128',
    'member_id': 'u64',
    'rationale': 'Bytes',
}
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'increase_stake', {
    'stake_balance_delta': 'u128',
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'lead_remark', {'msg': 'Bytes'}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'leave_role', {'rationale': (None, 'Bytes'), 'worker_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'set_budget', {'new_budget': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'set_status_text', {'status_text': (None, 'Bytes')}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'slash_stake', {
    'penalty': 'u128',
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'spend_from_budget', {
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'terminate_role', {
    'penalty': (None, 'u128'),
    'rationale': (None, 'Bytes'),
    'worker_id': 'u64',
}
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'update_reward_account', {
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'update_reward_amount', {
    'reward_per_block': (None, 'u128'),
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'update_role_account', {
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'withdraw_application', {'application_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'OperationsWorkingGroupBeta', 'worker_remark', {'msg': 'Bytes', 'worker_id': 'u64'}
)
```
...
result = substrate.query(
    'OperationsWorkingGroupBeta', 'ActiveWorkerCount', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'ApplicationById', ['u64']
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'Budget', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'CurrentLead', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'NextApplicationId', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'NextOpeningId', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'NextWorkerId', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'OpeningById', ['u64']
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'StatusTextHash', []
)
```
...
```python
result = substrate.query(
    'OperationsWorkingGroupBeta', 'WorkerById', ['u64']
)
```
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'LeaderOpeningStake')
```
---------
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'MaxWorkerNumberLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'MinUnstakingPeriodLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'MinimumApplicationStake')
```
---------
### RewardPeriod
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'RewardPeriod')
```
---------
...
#### Python
```python
constant = substrate.get_constant('OperationsWorkingGroupBeta', 'StakingHandlerLockId')
```
---------
## Errors
