...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'apply_on_opening', {
    'p': {
        'description': 'Bytes',
        'member_id': 'u64',
        'opening_id': 'u64',
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'cancel_opening', {'opening_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'decrease_stake', {
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'fund_working_group_budget', {
    'amount': 'u128',
    'member_id': 'u64',
    'rationale': 'Bytes',
}
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'increase_stake', {
    'stake_balance_delta': 'u128',
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'lead_remark', {'msg': 'Bytes'}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'leave_role', {'rationale': (None, 'Bytes'), 'worker_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'set_budget', {'new_budget': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'set_status_text', {'status_text': (None, 'Bytes')}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'spend_from_budget', {
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'terminate_role', {
    'penalty': (None, 'u128'),
    'rationale': (None, 'Bytes'),
    'worker_id': 'u64',
}
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'update_reward_account', {
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'update_reward_amount', {
    'reward_per_block': (None, 'u128'),
    'worker_id': 'u64',
}
)
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'update_role_account', {
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'withdraw_application', {'application_id': 'u64'}
)
```
...
```python
call = substrate.compose_call(
    'AppWorkingGroup', 'worker_remark', {'msg': 'Bytes', 'worker_id': 'u64'}
)
```
...
result = substrate.query(
    'AppWorkingGroup', 'ActiveWorkerCount', []
)
```
...
```python
result = substrate.query(
    'AppWorkingGroup', 'ApplicationById', ['u64']
)
```
...
```python
result = substrate.query(
    'AppWorkingGroup', 'NextApplicationId', []
)
```
...
```python
result = substrate.query(
    'AppWorkingGroup', 'OpeningById', ['u64']
)
```
...
```python
result = substrate.query(
    'AppWorkingGroup', 'StatusTextHash', []
)
```
...
```python
result = substrate.query(
    'AppWorkingGroup', 'WorkerById', ['u64']
)
```
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'LeaderOpeningStake')
```
---------
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'MaxWorkerNumberLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'MinUnstakingPeriodLimit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'MinimumApplicationStake')
```
---------
### RewardPeriod
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'RewardPeriod')
```
---------
...
#### Python
```python
constant = substrate.get_constant('AppWorkingGroup', 'StakingHandlerLockId')
```
---------
## Errors
