...
call = substrate.compose_call(
    'ParachainSystem', 'authorize_upgrade', {'code_hash': 'scale_info::9'}
)
```
...
call = substrate.compose_call(
    ...
    'data': {
        ...
        'horizontal_messages': 'scale_info::148',
        'relay_chain_state': {
            'trie_nodes': 'scale_info::132',
        },
        'validation_data': {
            'max_pov_size': 'u32',
            'parent_head': 'Bytes',
            'relay_parent_number': 'u32',
            'relay_parent_storage_root': 'scale_info::9',
        },
    },
}
)
...
| dmq_head | `relay_chain::Hash` | ```scale_info::9```
