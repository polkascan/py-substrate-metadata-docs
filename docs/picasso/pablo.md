...
| asset_amounts | `BTreeMap<T::AssetId, T::Balance>` | ```scale_info::181```
...
| asset_weights | `BTreeMap<T::AssetId, Permill>` | ```scale_info::177```
...
| twaps | `BTreeMap<T::AssetId, Rate>` | ```scale_info::185```
