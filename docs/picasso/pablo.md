...
| asset_amounts | `BTreeMap<T::AssetId, T::Balance>` | ```scale_info::182```
...
| asset_weights | `BTreeMap<T::AssetId, Permill>` | ```scale_info::178```
...
| twaps | `BTreeMap<T::AssetId, Rate>` | ```scale_info::186```
