        ...
        'event': {
            ...
            'AssetsRegistry': {
                ...
                'AssetLocationUpdated': {
                    'asset_id': 'u128',
                    'location': 'scale_info::151',
                },
                'AssetRegistered': {
                    'asset_id': 'u128',
                    'asset_info': 'scale_info::162',
                    'location': (None, 'scale_info::151'),
                },
                'AssetUpdated': {
                    'asset_id': 'u128',
                    'asset_info': 'scale_info::170',
                },
                'MinFeeUpdated': {
                    'amount': (None, 'u128'),
                    'foreign_asset_id': 'scale_info::151',
            ...
            'BondedFinance': {
                ...
                'NewOffer': {'beneficiary': 'AccountId', 'offer_id': 'u128'},
                'OfferCancelled': {'offer_id': 'u128'},
                'OfferCompleted': {'offer_id': 'u128'},
            },
            'CallFilter': {
                'Disabled': {'entry': 'scale_info::197'},
                'Enabled': {'entry': 'scale_info::197'},
            },
            'CollatorSelection': {
                'CandidateAdded': {
            ...
            'CrowdloanRewards': {
                ...
                'RewardsAdded': {
                    'additions': [('scale_info::133', 'u128', 'u64')],
                },
                'RewardsDeleted': {'deletions': ['scale_info::133']},
            ...
            'CurrencyFactory': {'RangeCreated': {'range': 'scale_info::130'}},
            'Democracy': {
                ...
                'MetadataSet': {'hash': '[u8; 32]', 'owner': 'scale_info::53'},
                'MetadataTransferred': {
                    'hash': '[u8; 32]',
                    'owner': 'scale_info::53',
            ...
            'Pablo': {
                ...
                'TwapUpdated': {
                    'pool_id': 'u128',
                    'timestamp': 'u64',
                    'twaps': 'scale_info::186',
                },
            },
            'PalletMultihopXcmIbc': {
                'FailedCallback': {
                    'origin_address': '[u8; 32]',
                    'reason': 'scale_info::220',
                    'route_id': 'u128',
                },
            ...
            'PolkadotXcm': {
                ...
                'Attempted': {
                    ...
                    'Error': 'scale_info::66',
                    'Incomplete': ('scale_info::8', 'scale_info::66'),
                },
            ...
            'Vesting': {
                'Claimed': {
                    'asset': 'u128',
                    'claimed_amount_per_schedule': 'scale_info::145',
                    'locked_amount': 'u128',
                    'vesting_schedule_ids': 'scale_info::141',
                    'who': 'AccountId',
                },
                'VestingScheduleAdded': {
                    'asset': 'u128',
                    'from': 'AccountId',
                    'schedule': 'scale_info::139',
