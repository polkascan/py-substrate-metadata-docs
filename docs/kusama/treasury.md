...
```python
{
    ...
    'asset_kind': {
        ...
        'V3': {
            'asset_id': {
                'Abstract': '[u8; 32]',
                'Concrete': {'interior': 'scale_info::61', 'parents': 'u8'},
            },
            'location': {
                'interior': {
                    'Here': None,
                    'X1': 'scale_info::62',
                    'X2': ('scale_info::62', 'scale_info::62'),
                    'X3': (
                        'scale_info::62',
                        'scale_info::62',
                        'scale_info::62',
    ...
    'beneficiary': {
        ...
        'V2': {
            'interior': {
                ...
                'X2': ('scale_info::73', 'scale_info::73'),
                'X3': ('scale_info::73', 'scale_info::73', 'scale_info::73'),
                'X4': (
                    'scale_info::73',
                    'scale_info::73',
                    'scale_info::73',
        ...
        'V3': {
            'interior': {
                ...
                'X2': ('scale_info::62', 'scale_info::62'),
                'X3': ('scale_info::62', 'scale_info::62', 'scale_info::62'),
                'X4': (
                    'scale_info::62',
                    'scale_info::62',
                    'scale_info::62',
