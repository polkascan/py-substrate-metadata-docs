...
[
    {
        'event': {
            ...
            'DappsStaking': {
                'BondAndStake': ('AccountId', 'scale_info::41', 'u128'),
                'ContractRemoved': ('AccountId', 'scale_info::41'),
                'MaintenanceMode': 'bool',
                'NewContract': ('AccountId', 'scale_info::41'),
                ...
                'Reward': ('AccountId', 'scale_info::41', 'u32', 'u128'),
                'RewardDestination': ('AccountId', 'scale_info::45'),
                'StaleRewardBurned': (
                    'AccountId',
                    'scale_info::41',
                    'u32',
                ...
                'UnbondAndUnstake': ('AccountId', 'scale_info::41', 'u128'),
            ...
            'EVM': {
                ...
                'Log': {'log': 'scale_info::100'},
            },
            'EthCall': {'Executed': ('AccountId', 'scale_info::30')},
            'Ethereum': {
                'Executed': {
                    'exit_reason': 'scale_info::103',
                    'from': '[u8; 20]',
                    'to': '[u8; 20]',
            ...
            'XcAssetConfig': {
                'AssetLocationChanged': {
                    'asset_id': 'u128',
                    'new_asset_location': 'scale_info::95',
                    'previous_asset_location': 'scale_info::95',
                },
                'AssetRegistered': {
                    'asset_id': 'u128',
                    'asset_location': 'scale_info::95',
                },
                'AssetRemoved': {
                    'asset_id': 'u128',
                    'asset_location': 'scale_info::95',
                },
                'SupportedAssetRemoved': {'asset_location': 'scale_info::95'},
