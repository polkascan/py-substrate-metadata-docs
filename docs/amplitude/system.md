...
[
    {
        'event': {
            ...
            'DiaOracleModule': {
                ...
                'UpdatedPrices': [(('Bytes', 'Bytes'), 'scale_info::111')],
            },
            'DmpQueue': {
                'ExecutedDownward': {
                    'message_id': '[u8; 32]',
            ...
            'ZenlinkProtocol': {
                ...
                'Burned': ('scale_info::113', 'AccountId', 'u128'),
                'ChargeReward': (
                    'scale_info::113',
                    'scale_info::113',
                    'AccountId',
                ...
                'Minted': ('scale_info::113', 'AccountId', 'u128'),
                'PairCreated': ('scale_info::113', 'scale_info::113'),
                'Transferred': (
                    'scale_info::113',
                    'AccountId',
                    'AccountId',
