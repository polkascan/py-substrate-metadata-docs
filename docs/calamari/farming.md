...
{
    'gauge_amount': 'u128',
    'gauge_basic_rewards': 'scale_info::482',
    'gauge_last_block': 'u32',
...
```python
{
    ...
    'min_deposit_to_start': 'u128',
    'reward_issuer': 'AccountId',
    'rewards': 'scale_info::483',
    'state': ('UnCharged', 'Charged', 'Ongoing', 'Dead', 'Retired'),
    'tokens_proportion': 'scale_info::481',
    'total_shares': 'u128',
    'withdraw_limit_count': 'u8',
    'withdraw_limit_time': 'u32',
}
...
```python
{
    ...
    'withdrawn_rewards': 'scale_info::482',
}
```
---------
## Constants
