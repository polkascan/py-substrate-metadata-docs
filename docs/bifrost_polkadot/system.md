...
[
    {
        'event': {
            'AssetRegistry': {
                'AssetRegistered': {
                    'asset_id': 'scale_info::142',
                    'metadata': 'scale_info::143',
                },
                'AssetUpdated': {
                    'asset_id': 'scale_info::142',
                    'metadata': 'scale_info::143',
            ...
            'CallSwitchgear': {
                ...
                'TransferAccountDisabled': {
                    ...
                    'Native': 'scale_info::127',
                    'Stable': 'scale_info::127',
                    'StableLpToken': 'u32',
                    'Token': 'scale_info::127',
                    'Token2': 'u8',
                    'VSBond': ('scale_info::127', 'u32', 'u32', 'u32'),
                    'VSBond2': ('u8', 'u32', 'u32', 'u32'),
                    'VSToken': 'scale_info::127',
                    'VSToken2': 'u8',
                    'VToken': 'scale_info::127',
                    'VToken2': 'u8',
                },
            ...
            'CrossInOut': {
                ...
                'CurrencyDeregistered': {'currency_id': 'scale_info::126'},
                'CurrencyRegistered': {'currency_id': 'scale_info::126'},
                'LinkedAccountRegistered': {
                    'currency_id': 'scale_info::126',
                    'foreign_location': 'scale_info::98',
                    'who': 'AccountId',
                },
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 32]', 'scale_info::56'),
                'InvalidFormat': '[u8; 32]',
            ...
            'Farming': {
                ...
                'AllRetired': {'pid': 'u32'},
                'BoostCharged': {'rewards': [('scale_info::126', 'u128')], 'who': 'AccountId'},
                'Charged': {
                    'pid': 'u32',
                    'rewards': [('scale_info::126', 'u128')],
                    'who': 'AccountId',
                },
            ...
            'FeeShare': {
                'Created': {'info': 'scale_info::217'},
                'Deleted': {'distribution_id': 'u32'},
                'Edited': {'info': 'scale_info::217'},
            ...
            'FlexibleFee': {
                ...
                'FixedRateFeeExchanged': ('scale_info::126', 'u128'),
                'FlexibleFeeExchanged': ('scale_info::126', 'u128'),
            },
            'Identity': {
            ...
            'PolkadotXcm': {
                ...
                'Attempted': {
                    ...
                    'Error': 'scale_info::53',
                    'Incomplete': ('scale_info::8', 'scale_info::53'),
                },
                'FeesPaid': ('scale_info::57', ['scale_info::72']),
                'InvalidQuerier': (
                    'scale_info::57',
                    'u64',
                    'scale_info::57',
                ...
                'InvalidQuerierVersion': ('scale_info::57', 'u64'),
                'InvalidResponder': (
                    'scale_info::57',
                    'u64',
                    (None, 'scale_info::57'),
                ...
                'NotifyTargetMigrationFail': ('scale_info::107', 'u64'),
                ...
                'VersionNotifyStarted': ('scale_info::57', ['scale_info::72']),
            ...
            'Slp': {
                ...
                'Liquidize': {
                    ...
                    'query_id': 'u64',
                    'query_id_hash': '[u8; 32]',
                    'time_unit': (None, 'scale_info::145'),
                },
                'MinimumsMaximumsSet': {
                    'currency_id': 'scale_info::126',
                    'minimums_and_maximums': (None, 'scale_info::187'),
                },
                ...
                'ValidatorBoostListSet': {
                    'currency_id': 'scale_info::126',
                    'validator_boost_list': [('scale_info::57', 'u32')],
                },
                'ValidatorsAdded': {
                    'currency_id': 'scale_info::126',
                ...
                'ValidatorsReset': {
                    'currency_id': 'scale_info::126',
                    'validator_list': ['scale_info::57'],
                },
                'XcmDestWeightAndFeeSet': {
                    'currency_id': 'scale_info::126',
                    'operation': 'scale_info::153',
            ...
            'SystemMaker': {
                ...
                'Closed': {'currency_id': 'scale_info::126'},
                'ConfigSet': {
                    'currency_id': 'scale_info::126',
                    'info': 'scale_info::215',
                },
                'Paid': {'currency_id': 'scale_info::126', 'value': 'u128'},
                'RedeemFailed': {
                    'amount': 'u128',
                    'vcurrency_id': 'scale_info::126',
                },
            },
            'SystemStaking': {
                'DepositFailed': {
                ...
                'TokenInfoRefreshed': {'token': 'scale_info::126'},
                'VtokenNotFound': {'token': 'scale_info::126'},
                'WithdrawFailed': {
                    'amount': 'u128',
                    'farming_staking_amount': 'u128',
                    'pending_redeem_amount': 'u128',
            ...
            'TokenConversion': {
                'ExchangeFeeSet': {'exchange_fee': 'scale_info::199'},
                'ExchangeRateSet': {
                    'exchange_rate': 'scale_info::201',
                    'lease': 'i32',
                },
            ...
            'VeMinting': {
                ...
                'ConfigSet': {'config': 'scale_info::225'},
                ...
                'RewardAdded': {'rewards': [('scale_info::126', 'u128')]},
                'Rewarded': {
                    'addr': 'AccountId',
                    'rewards': [('scale_info::126', 'u128')],
                },
            ...
            'VtokenMinting': {
                ...
                'SupportRebondTokenAdded': {'token_id': 'scale_info::126'},
                'SupportRebondTokenRemoved': {'token_id': 'scale_info::126'},
                'UnlockDurationSet': {
                    'token_id': 'scale_info::126',
                    'unlock_duration': 'scale_info::145',
                },
                'UnlockingTotalSet': {
                    'amount': 'u128',
                    'token_id': 'scale_info::126',
            ...
            'XcmAction': {
                ...
                'XcmSwap': {
                    'currency_id_in': 'scale_info::126',
                    'currency_id_out': 'scale_info::126',
                    'evm_caller': '[u8; 20]',
                    'support_chain': 'scale_info::227',
                },
                'XcmSwapFailed': {
            ...
            'XcmInterface': {
                ...
                'XcmDestWeightUpdated': ('scale_info::197', 'scale_info::8'),
                'XcmFeeUpdated': ('scale_info::197', 'u128'),
            },
            'XcmpQueue': {
            ...
            'ZenlinkProtocol': {
                ...
                'Burned': ('scale_info::131', 'AccountId', 'u128'),
                'ChargeReward': (
                    'scale_info::131',
                    'scale_info::131',
                    'AccountId',
                ...
                'Minted': ('scale_info::131', 'AccountId', 'u128'),
                'PairCreated': ('scale_info::131', 'scale_info::131'),
                'Transferred': (
                    'scale_info::131',
                    'AccountId',
                    'AccountId',
