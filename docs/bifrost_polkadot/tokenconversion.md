...
```python
call = substrate.compose_call(
    'TokenConversion', 'set_relaychain_lease', {'lease': 'u32'}
)
```
...
```python
result = substrate.query(
    'TokenConversion', 'ExchangeRate', ['i32']
)
```
...
```python
result = substrate.query(
    'TokenConversion', 'RelaychainLease', []
)
```
...
#### Python
```python
constant = substrate.get_constant('TokenConversion', 'RelayCurrencyId')
```
---------
### TreasuryAccount
#### Value
...
#### Python
```python
constant = substrate.get_constant('TokenConversion', 'TreasuryAccount')
```
---------
### VsbondAccount
#### Value
...
#### Python
```python
constant = substrate.get_constant('TokenConversion', 'VsbondAccount')
```
---------
## Errors
