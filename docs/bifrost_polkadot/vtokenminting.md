...
```python
call = substrate.compose_call(
    'VtokenMinting', 'set_hook_iteration_limit', {'limit': 'u32'}
)
```
...
| Name | Type | Composition
| -------- | -------- | -------- |
| mint_fee | `Permill` | ```u32```
| redeem_fee | `Permill` | ```u32```
...
| remark | `BoundedVec<u8, ConstU32<32>>` | ```Bytes```
...
```python
result = substrate.query(
    'VtokenMinting', 'HookIterationLimit', []
)
```
...
```python
result = substrate.query(
    'VtokenMinting', 'TokenUnlockLedger', [
    {
        'BLP': 'u32',
        'ForeignAsset': 'u32',
        'LPToken': (
...
```python
result = substrate.query(
    'VtokenMinting', 'TokenUnlockNextId', [
    {
        'BLP': 'u32',
        'ForeignAsset': 'u32',
        'LPToken': (
...
```python
result = substrate.query(
    'VtokenMinting', 'UserUnlockLedger', [
    'AccountId',
    {
        'BLP': 'u32',
        'ForeignAsset': 'u32',
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'EntranceAccount')
```
---------
### ExitAccount
#### Value
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'ExitAccount')
```
---------
### FeeAccount
#### Value
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'InterlayParachainId')
```
---------
### MantaParachainId
#### Value
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'MantaParachainId')
```
---------
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'MaximumUnlockIdOfTimeUnit')
```
---------
...
#### Python
```python
constant = substrate.get_constant('VtokenMinting', 'RelayChainToken')
```
---------
## Errors
