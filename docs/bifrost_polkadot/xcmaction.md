...
| -------- | -------- | -------- |
| support_chain | `SupportChain` | ```('Astar', 'Moonbeam')```
...
```python
result = substrate.query(
    'XcmAction', 'TransferToFee', [('Astar', 'Moonbeam')]
)
```
...
```python
result = substrate.query(
    'XcmAction', 'WhitelistAccountId', [('Astar', 'Moonbeam')]
)
```
...
#### Python
```python
constant = substrate.get_constant('XcmAction', 'ParachainId')
```
---------
### TreasuryAccount
 TreasuryAccount
...
#### Python
```python
constant = substrate.get_constant('XcmAction', 'TreasuryAccount')
```
---------
## Errors
