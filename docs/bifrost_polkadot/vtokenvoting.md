    ...
    (
        {
            'BLP': 'u32',
            'ForeignAsset': 'u32',
            'LPToken': ('scale_info::249', 'u8', 'scale_info::249', 'u8'),
            'Native': (
                'ASG',
                'BNC',
                'KUSD',
...
```python
{
    'Casting': {
        ...
        'prior': ('u32', 'u128'),
        'votes': [('u32', 'scale_info::365', 'u16', 'u128')],
    },
    'Delegating': {
        'balance': 'u128',
        'conviction': (
