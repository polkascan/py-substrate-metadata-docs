...
```python
{
    'ParachainReserve': {
        'interior': {
            'Here': None,
            'X1': {
                'AccountId32': {'id': '[u8; 32]', 'network': 'scale_info::75'},
                'AccountIndex64': {
                    'index': 'u64',
                    'network': 'scale_info::75',
                },
