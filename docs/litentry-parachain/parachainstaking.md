...
call = substrate.compose_call(
    'ParachainStaking', 'add_candidates_whitelist', {'candidate': 'AccountId'}
)
```
...
```python
call = substrate.compose_call(
    'ParachainStaking', 'execute_leave_candidates', {'candidate': 'AccountId'}
)
```
...
```python
call = substrate.compose_call(
    'ParachainStaking', 'execute_leave_delegators', {'delegator': 'AccountId'}
)
```
...
```python
call = substrate.compose_call(
    'ParachainStaking', 'join_candidates', {'bond': 'u128'}
)
```
...
```python
call = substrate.compose_call(
    'ParachainStaking', 'remove_candidates_whitelist', {'candidate': 'AccountId'}
)
```
