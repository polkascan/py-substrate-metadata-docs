...
| -------- | -------- | -------- |
| currency_id | `T::CurrencyId` | ```('DOT', 'USDT', 'USDC')```
...
result = substrate.query(
    'Tokens', 'Accounts', ['AccountId', ('DOT', 'USDT', 'USDC')]
)
```
...
```python
result = substrate.query(
    'Tokens', 'Locks', ['AccountId', ('DOT', 'USDT', 'USDC')]
)
```
...
```python
result = substrate.query(
    'Tokens', 'Reserves', ['AccountId', ('DOT', 'USDT', 'USDC')]
)
```
...
```python
result = substrate.query(
    'Tokens', 'TotalIssuance', [('DOT', 'USDT', 'USDC')]
)
```
