...
| call_hash | `CallHashOf<T>` | ```scale_info::11```
...
| proxy_type | `T::ProxyType` | ```('Any', 'NonTransfer', 'CancelProxy', 'Balances')```
...
#### Return value
```python
([{'call_hash': 'scale_info::11', 'height': 'u32', 'real': 'AccountId'}], 'u128')
```
---------
### Proxies
    ...
    [
        {
            'delay': 'u32',
            'delegate': 'AccountId',
            'proxy_type': ('Any', 'NonTransfer', 'CancelProxy', 'Balances'),
        },
    ],
    'u128',
)
