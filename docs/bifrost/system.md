...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 32]', 'scale_info::383'),
                'InvalidFormat': '[u8; 32]',
            ...
            'FeeShare': {
                'Created': {'info': 'scale_info::429'},
                'Deleted': {'distribution_id': 'u32'},
                'Edited': {'info': 'scale_info::429'},
            ...
            'FellowshipReferenda': {
                'Approved': {'index': 'u32'},
                'Cancelled': {'index': 'u32', 'tally': 'scale_info::435'},
                'ConfirmAborted': {'index': 'u32'},
                'ConfirmStarted': {'index': 'u32'},
                'Confirmed': {'index': 'u32', 'tally': 'scale_info::435'},
                ...
                'Killed': {'index': 'u32', 'tally': 'scale_info::435'},
                'MetadataCleared': {'hash': '[u8; 32]', 'index': 'u32'},
                'MetadataSet': {'hash': '[u8; 32]', 'index': 'u32'},
                'Rejected': {'index': 'u32', 'tally': 'scale_info::435'},
                ...
                'TimedOut': {'index': 'u32', 'tally': 'scale_info::435'},
            },
            'FlexibleFee': {
                'ExtraFeeDeducted': (
                    'scale_info::405',
            ...
            'Referenda': {
                'Approved': {'index': 'u32'},
                'Cancelled': {'index': 'u32', 'tally': 'scale_info::376'},
                'ConfirmAborted': {'index': 'u32'},
                'ConfirmStarted': {'index': 'u32'},
                'Confirmed': {'index': 'u32', 'tally': 'scale_info::376'},
                'DecisionDepositPlaced': {
                    'amount': 'u128',
                    'index': 'u32',
                    'who': 'AccountId',
                ...
                'DecisionStarted': {
                    'index': 'u32',
                    'proposal': 'scale_info::61',
                    'tally': 'scale_info::376',
                    'track': 'u16',
                },
                'DepositSlashed': {'amount': 'u128', 'who': 'AccountId'},
                'Killed': {'index': 'u32', 'tally': 'scale_info::376'},
                'MetadataCleared': {'hash': '[u8; 32]', 'index': 'u32'},
                'MetadataSet': {'hash': '[u8; 32]', 'index': 'u32'},
                'Rejected': {'index': 'u32', 'tally': 'scale_info::376'},
                'SubmissionDepositRefunded': {
                    'amount': 'u128',
                    'index': 'u32',
                    'who': 'AccountId',
                ...
                'TimedOut': {'index': 'u32', 'tally': 'scale_info::376'},
            },
            'Salp': {
                'AllRefunded': 'u32',
                'AllUnlocked': 'u32',
            ...
            'Slp': {
                ...
                'Liquidize': {
                    ...
                    'query_id': 'u64',
                    'query_id_hash': '[u8; 32]',
                    'time_unit': (None, 'scale_info::294'),
                },
                'MinimumsMaximumsSet': {
                    'currency_id': 'scale_info::255',
                    'minimums_and_maximums': (None, 'scale_info::328'),
                },
            ...
            'VstokenConversion': {
                'ExchangeFeeSet': {'exchange_fee': 'scale_info::341'},
                'ExchangeRateSet': {
                    'exchange_rate': 'scale_info::343',
                    'lease': 'i32',
                },
            ...
            'VtokenMinting': {
                ...
                'UnlockDurationSet': {
                    'token_id': 'scale_info::255',
                    'unlock_duration': 'scale_info::294',
                },
                'UnlockingTotalSet': {
                    'amount': 'u128',
                    'token_id': 'scale_info::255',
            ...
            'XcmInterface': {
                ...
                'XcmDestWeightUpdated': ('scale_info::338', 'scale_info::9'),
                'XcmFeeUpdated': ('scale_info::338', 'u128'),
            },
            'XcmpQueue': {
