...
```python
{
    'Casting': {
        ...
        'prior': ('u32', 'u128'),
        'votes': [('u32', 'scale_info::382', 'u16', 'u128')],
    },
    'Delegating': {
        'balance': 'u128',
        'conviction': (
