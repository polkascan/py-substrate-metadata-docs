...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 32]', 'scale_info::74'),
                'InvalidFormat': '[u8; 32]',
            ...
            'NFT': {
                'CollectionCreated': {
                    'collection_id': 'u128',
                    'collection_type': 'scale_info::144',
                    'metadata': 'Bytes',
                    'owner': 'AccountId',
                },
                'CollectionDestroyed': {
            ...
            'OrmlXcm': {
                'Sent': {'message': ['scale_info::87'], 'to': 'scale_info::76'},
            },
            'ParachainSystem': {
            ...
            'PolkadotXcm': {
                ...
                'Attempted': {'outcome': 'scale_info::74'},
                'FeesPaid': {'fees': ['scale_info::90'], 'paying': 'scale_info::76'},
                'InvalidQuerier': {
                    'expected_querier': 'scale_info::76',
                    'maybe_actual_querier': (None, 'scale_info::76'),
                    'origin': 'scale_info::76',
                    'query_id': 'u64',
                },
                ...
                'InvalidResponder': {
                    'expected_location': (None, 'scale_info::76'),
                    'origin': 'scale_info::76',
                    'query_id': 'u64',
                },
            ...
            'Vesting': {
                ...
                'VestingScheduleAdded': {
                    'from': 'AccountId',
                    'to': 'AccountId',
                    'vesting_schedule': 'scale_info::49',
                },
            ...
            'XYKLiquidityMining': {
                ...
                'YieldFarmCreated': {
                    'asset_pair': 'scale_info::154',
                    'global_farm_id': 'u32',
                    'loyalty_curve': (None, 'scale_info::156'),
                    'multiplier': 'u128',
                    'yield_farm_id': 'u32',
                },
                'YieldFarmResumed': {
