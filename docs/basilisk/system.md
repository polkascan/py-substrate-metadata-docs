...
[
    {
        'event': {
            ...
            'CumulusXcm': {
                'ExecutedDownward': ('[u8; 8]', 'scale_info::72'),
                'InvalidFormat': '[u8; 8]',
            ...
            'Democracy': {
                ...
                'Executed': {'ref_index': 'u32', 'result': 'scale_info::33'},
                'ExternalTabled': None,
            ...
            'NFT': {
                'CollectionCreated': {
                    'collection_id': 'u128',
                    'collection_type': 'scale_info::127',
                    'metadata': 'Bytes',
                    'owner': 'AccountId',
                },
                'CollectionDestroyed': {
            ...
            'PolkadotXcm': {
                ...
                'ResponseReady': ('u64', 'scale_info::95'),
                'ResponseTaken': 'u64',
                'Sent': (
                    'scale_info::74',
                    'scale_info::74',
            ...
            'XYKLiquidityMining': {
                ...
                'YieldFarmCreated': {
                    'asset_pair': 'scale_info::136',
                    'global_farm_id': 'u32',
                    'loyalty_curve': (None, 'scale_info::138'),
                    'multiplier': 'u128',
                    'yield_farm_id': 'u32',
                },
                'YieldFarmResumed': {
...
```python
{
    ...
    'per_class': {
        'mandatory': {
            'base_extrinsic': {'ref_time': 200000000},
            'max_extrinsic': None,
            'max_total': None,
            'reserved': None,
        },
        'normal': {
            'base_extrinsic': {'ref_time': 200000000},
            'max_extrinsic': {'ref_time': 362300000000},
            'max_total': {'ref_time': 375000000000},
            'reserved': {'ref_time': 0},
        },
        'operational': {
            'base_extrinsic': {'ref_time': 200000000},
            'max_extrinsic': {'ref_time': 487300000000},
