...
call = substrate.compose_call(
    'CrowdloanDistribution', 'transfer', {
    'asset': 'u64',
    'target': 'AccountId',
    'value': 'u128',
}
...
```python
call = substrate.compose_call(
    'CrowdloanDistribution', 'vested_transfer', {
    'schedule': (
        'u128',
        'u128',
        'u32',
...
result = substrate.query(
    'CrowdloanDistribution', 'PalletManager', []
)
```
...
#### Python
```python
constant = substrate.get_constant('CrowdloanDistribution', 'PalletId')
```
---------
## Errors
