...
call = substrate.compose_call(
    'Vesting3', 'force_vested_transfer', {
    'schedule': {
        'locked': 'u128',
        'per_block': 'u128',
        'starting_block': 'u32',
...
#### Python
```python
constant = substrate.get_constant('Vesting3', 'MinVestedTransfer')
```
---------
### PalletId
#### Value
...
#### Python
```python
constant = substrate.get_constant('Vesting3', 'PalletId')
```
---------
## Errors
