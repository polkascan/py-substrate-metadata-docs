...
call = substrate.compose_call(
    ...
    'data': {
        ...
        'horizontal_messages': 'scale_info::205',
        'relay_chain_state': {
            'trie_nodes': 'scale_info::187',
        },
        'validation_data': {
            'max_pov_size': 'u32',
            'parent_head': 'Bytes',
            'relay_parent_number': 'u32',
            'relay_parent_storage_root': 'scale_info::16',
        },
    },
}
)
...
| dmq_head | `relay_chain::Hash` | ```scale_info::16```
...
| Name | Type | Composition
| -------- | -------- | -------- |
| code_hash | `T::Hash` | ```scale_info::16```
...
#### Return value
```python
{'check_version': 'bool', 'code_hash': 'scale_info::16'}
```
---------
