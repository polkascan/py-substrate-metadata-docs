...
```python
call = substrate.compose_call(
    'Democracy', 'veto_external', {'proposal_hash': 'scale_info::16'}
)
```
...
| -------- | -------- | -------- |
| proposal_hash | `H256` | ```scale_info::16```
...
| hash | `PreimageHash` | ```scale_info::16```
...
result = substrate.query(
    'Democracy', 'Blacklist', ['scale_info::16']
)
```
...
```python
result = substrate.query(
    'Democracy', 'Cancellations', ['scale_info::16']
)
```
...
(
    {
        'Inline': 'Bytes',
        'Legacy': {'hash': 'scale_info::16'},
        'Lookup': {'hash': 'scale_info::16', 'len': 'u32'},
    },
