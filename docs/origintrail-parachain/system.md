...
[
    {
        'event': {
            ...
            'EVM': {
                ...
                'Log': {'log': 'scale_info::87'},
            },
            'Ethereum': {
                'Executed': {
                    'exit_reason': 'scale_info::91',
                    'from': '[u8; 20]',
                    'to': '[u8; 20]',
            ...
            'PolkadotXcm': {
                ...
                'NotifyTargetMigrationFail': ('scale_info::36', 'u64'),
                'NotifyTargetSendFail': (
                    'scale_info::47',
                    'u64',
                    'scale_info::55',
                ),
                'ResponseReady': ('u64', 'scale_info::70'),
                'ResponseTaken': 'u64',
                'Sent': (
                    'scale_info::47',
                    'scale_info::47',
                ...
                'VersionChangeNotified': ('scale_info::47', 'u32'),
            },
            'Scheduler': {
                'CallLookupFailed': {
                    'error': 'scale_info::108',
                    'id': (None, 'Bytes'),
                    'task': ('u32', 'u32'),
                },
            ...
            'Sudo': {
                ...
                'Sudid': {'sudo_result': 'scale_info::106'},
                'SudoAsDone': {'sudo_result': 'scale_info::106'},
            },
            'System': {
                'CodeUpdated': None,
                'ExtrinsicFailed': {
            ...
            'TemplatePallet': {'SomethingStored': ('u32', 'AccountId')},
            'TransactionPayment': {
                'TransactionFeePaid': {
                    'actual_fee': 'u128',
                    'tip': 'u128',
            ...
            'XcAssetConfig': {
                'AssetLocationChanged': {
                    'asset_id': 'u128',
                    'new_asset_location': 'scale_info::36',
                    'previous_asset_location': 'scale_info::36',
                },
                'AssetRegistered': {
                    'asset_id': 'u128',
                ...
                'SupportedAssetRemoved': {'asset_location': 'scale_info::36'},
